...
if (!addonRelativeDir.startsWith('official/') || addonRelativeDir.split('/').includes('..')) {
  fail(`physical addon sources must live under official: ${addonArg}`)
}
...
if (previousBuildTarget !== undefined) process.env.CARGO_BUILD_TARGET = previousBuildTarget
